<?php
  ...
  $content = "matchacake viewed at time => ".date('Y-m-d').date(' H:i:s', time());
  $type = "Pastry";
  echo $content;
          ...
          <div class="col-md-6">
              ...
              <div class="list-group-item">
                ...
                <div class="col-md-12 text-right">
                    ...
                    <div class="col-md-6">
            <form id="frmreview" role="form" method="post" action="matchacake.php">
              <fieldset>
                ...
                <input id="abc" class="hidden" name="rating" value="5" />
                    ...
                    <br />
                    <input type="text" class="hidden" value="matchacake" name="ProductName" />
            ...
            <!--facebook-->
            <div class="fb-like" data-href="http://www.captainlongxu.com/marketplace/pastry/matchacake.php" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
            <!--facebook-->
          </div>
